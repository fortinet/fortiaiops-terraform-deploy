...
variable "image" {
  type    = string
  default = "projects/fortigcp-project-001/global/images/fortiaiops-202-build0165-lic"
}
...
# Enter the Reserved External IP name if there is to attach already existing Public IP, if not Public IP will be picked up from DHCP
